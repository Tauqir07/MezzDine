...
>
  <svg className="rd-whatsapp-icon" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.558 4.116 1.535 5.846L.057 23.571l5.873-1.54A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.885 0-3.65-.52-5.157-1.424l-.37-.22-3.487.914.93-3.4-.241-.35A9.953 9.953 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
  </svg>
  WhatsApp Owner
</a>
    ) : (
    ...
    {/* Chat button */}
    <button
       className="rd-chat-btn" onClick={contactOwner}>
